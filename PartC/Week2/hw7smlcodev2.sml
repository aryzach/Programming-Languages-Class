...
fun eval_prog (e,env) =
	...
	case ge of
	  ...
	  (* below I don't think I should return eval_prog(Shift...) edit: actually I think it's right *)
	  | _ => eval_prog(Shift(dx, dy, eval_prog(ge,env)), env)
(* CHANGE: Add a case for Shift expressions *)

(* CHANGE: Add function preprocess_prog of type geom_exp -> geom_exp *)
fun preprocess_prog (ge) =
    case ge of
	NoPoints => ge
      | Point _ => ge
      | Line _ => ge
