...
class NoPoints < GeometryValue
  ...
  def intersect other
    ...
    # (my note: isn't this bad bc NoPoint.intersect NoPoint won't terminate, edit: I'm wrong, it calls a different method which is defined in the superclass)
  end
...
class Let < GeometryExpression
  ...
  def eval_prog env
    e2.preprocess_prog.eval_prog(env.unshift([s,e1.preprocess_prog.eval_prog(env)]))
  end
